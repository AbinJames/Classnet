...
<body translate="no" >
  ...
  <section id="sidebar"> 
    <div id="sidebar-nav">   
      <ul>
        <li class="active"><a rel="nofollow" rel="noreferrer"href="homepage.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
  ...
  <section id="content">
    ...
    <div class="content">
      <div class="content-header">
        <h1><?php
          echo "Hello, ";echo $row['firstname'];echo " ";echo $row['lastname'];
          ?></h1>
        </div>
        <iframe id="iframe1" name ="iframe1" target = "iframe2" src="dashboard.php" width="100%" height="90%" frameborder="0"></iframe>
      </div>

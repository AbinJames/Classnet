...
<?php
  ...
  echo '<div class="panel-body">
    <img align="middle" class="img-user center-block img-circle img-size" src="'. $them['profile'] .'"/><br>
    <h4 class="text-center"><a href="profileimg.php">Change Picture</a></h4></div>
      ';
    ?>
    </div>
</body>
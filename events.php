				...
				<div id="small-dialog" class="mfp-hide">
					<div class="event-text">
						<form action="insert.php" method="post">						
							...
							<input type="date" name = "eventdate"value="Select date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Select date';}"/>
							<textarea name = "message" placeholder= "Message" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Message';}"></textarea>

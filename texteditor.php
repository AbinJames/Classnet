...
<body translate="no" >
  ...
  <section id="sidebar"> 
    <div id="sidebar-nav">   
      <ul>
        <li class="active"><a rel="nofollow" rel="noreferrer" href="texteditor.php?tid=-1"><i class="fa fa-pencil-square-o"></i> Create Note</a></li>
  ...
  <section id="content">
    ...
    <div class="content">
      ...
      <?php
      echo '<iframe id="iframe1" name ="iframe1" src="text.php?id='.$tid.'" width="100%" height="100%" frameborder="0"></iframe>';
      ?>
    </div>

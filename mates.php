...
<body translate="no" >
  ...
  <section id="sidebar"> 
    <div id="sidebar-nav">   
      <ul>
        <li class="active"><a rel="nofollow" rel="noreferrer" href="mates.php"><i class="fa fa-users"></i> My Buddies</a></li>
        <li><a rel="nofollow" rel="noreferrer" href="homepage.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li><a rel="nofollow" rel="noreferrer" href="texteditor.php?id=-1"><i class="fa fa-pencil-square-o"></i> Create Note</a></li>
  ...
  <section id="content">
     ...
     <div class="content">
      ...
      <iframe id="iframe1" name ="iframe1" target = "iframe2" src="profiles.php" width="50%" height="90%" frameborder="0"></iframe>

...
<body translate="no" >
  ...
  <section id="sidebar"> 
    <div id="sidebar-nav">   
      <ul>
        <li class="active"><a rel="nofollow" rel="noreferrer" href="allnotes.php"><i class="fa fa-file"></i> All Notes</a></li>
  ...
  <section id="content">
     ...
     <iframe id="iframe1" name ="iframe1" target = "iframe2" src="note.php" width="50%" height="90%" frameborder="0"></iframe>

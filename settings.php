...
<body translate="no" >
  ...
  <section id="sidebar"> 
    <div id="sidebar-nav">   
      <ul>
        <li class="active"><a rel="nofollow" rel="noreferrer"href="settings.php"><i class="fa fa-gear"></i> Settings</a></li>
 ...
 <iframe id="iframe1" name ="iframe1" src="user_settings.php" target="iframe2" width="100%" height="90%" frameborder="0"></iframe>

...
<body translate="no" >
  ...
  <section id="sidebar"> 
    <div id="sidebar-nav">   
      <ul>
        <li class="active"><a rel="nofollow" rel="noreferrer"href="uploadr.php"><i class="fa fa-upload"></i> Upload Resources</a></li>
 ...
 <iframe id="iframe1" name ="iframe1" src="fileupload.php" target="iframe2" width="50%" height="90%" frameborder="0"></iframe>
 <iframe id="iframe2" style = "float:right" name ="iframe2" src="" width="50%" height="90%" frameborder="0"></iframe>
